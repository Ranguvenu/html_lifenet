<?php
// $Id: file.php,v 1.46.2.6 2011/02/02 13:15:23 moodlerobot Exp $
...
//        require_login($course->id, true, null, false);
        ...
        //dev130 do not require login for middle content upload  -- START
        	$url_split =explode('/',$relativepath);
        	if($url_split[2]!='siteimages')
        	{
        	  // require_login(0, true, null, false);
          }
          //dev130 do not require login for middle content upload -- END
        }
    }
