...
$string['notificationmsgcertificaterenewal'] = 'Hi {$a->fullname},<br /><br />Your certificate is need to renewal! You will find it here:
    <a href="{$a->url}">My Certificates</a>';
$string['notificationsubjectcertificaterenewal'] = 'Your certificate need to renewal';
$string['taskcertificaterenewal'] = 'Renewal Certificate Task';
$string['edit'] = 'Edit';
$string['certificateupdated'] = 'Certificate updated';
$string['renewal'] = 'Renewal';
$string['cost'] = 'Renewal fee';
$string['currency'] = 'Currency';
$string['notificationsubjectcertificaterenewalpayment'] = 'Certificate renewal payment details';
$string['notificationmsgcertificaterenewalpayment'] = 'Certificate renewal fee {$a->cost} is successfully paid by {$a->fullname} for course {$a->coursename}.';
$string['select_certificatetemplate'] = 'Select certificate template';
