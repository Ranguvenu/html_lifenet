...
namespace block_lessons\output;
...
class mobile {
     ...
     */
    public static function viewlessons($args) {
        ...
        $html = $OUTPUT->render_from_template('block_lessons/mobile/'. $foldername . 'lessons', $data);
     ...
     * @throws \moodle_exception
     */
    public static function alllessons($args) {
        global $CFG, $DB, $PAGE, $OUTPUT, $USER;
