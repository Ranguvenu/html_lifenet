...
class mobile {
     ...
     */
    public static function reportdashboard($args) {
        ...
        $start = 0;
        $limit = 5;
        $report = $reportdashboard->reportdashboard($reportid, '', $start, $limit);

        $html = $OUTPUT->render_from_template('block_reportdashboard/mobile/'. $foldername . 'reportdashboard', $report);
