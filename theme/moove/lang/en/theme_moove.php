...
$string['region-top-full-region'] = 'Top Full Width Region';
...
$string['loginwithpassword'] = 'Log in with Password';
$string['otplogin'] = 'Log in with OTP';
$string['otpregistration'] = 'Register with Mobile Number';
