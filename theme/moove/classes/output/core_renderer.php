...
/**
    ...
    public function render_otplogin(\core_auth\output\otplogin $form) {
        ...
        $context->logourl = $url;
        $context->loginlogo = $this->get_logo();
        $context->output = $OUTPUT;
        //$context->loginslider = $this->loginslider();
        $context->revokethreshold =get_config('auth_otp', 'revokethreshold');
     ...
     * @return string
     */
    public function render_otpregistration(\core_auth\output\otpregistration $form) {
        global $CFG, $SITE ,$OUTPUT;
        ...
        return $this->render_from_template('core/otpregisterform', $context);
    }
    /**
