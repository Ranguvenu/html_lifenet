...
* Create a new application where you can configure the callback url. The URL is in the format "https://example.com/payment/gateway/mpesakenya/callback.php".
...
```bash
git clone https://github.com/iplusacademy/moodle-paygw_mtnafrica.git payment/gateway/mpesakenya
```
