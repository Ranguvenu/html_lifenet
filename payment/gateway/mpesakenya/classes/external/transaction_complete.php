...
class transaction_complete extends external_api {
    ...
    public static function execute_parameters() {
        return new external_function_parameters([
            ...
            'merchantrequestid' => new external_value(PARAM_TEXT, 'The order id coming back from MTN Africa'),
        ]);
    }
     ...
     * @return array
     */
    public static function execute(string $component, string $paymentarea, int $itemid, string $merchantrequestid): array {
        global $USER;
        ...
        $config = helper::get_gateway_configuration($component, $paymentarea, $itemid, 'mpesakenya');
        $helper = new mpesa_helper($config);
        $trans = $helper->certificate_renewal($merchantrequestid, $itemid, $component, $paymentarea);
        return ['success' => $trans != 'FAILED', 'message' => $trans['status'], 'desc' => $trans['desc']];
    }
    ...
    public static function execute_returns() {
        return new external_function_parameters([
            ...
            'desc' => new external_value(PARAM_RAW, 'Description regarding error'),
        ]);
    }
}
