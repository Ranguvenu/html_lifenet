...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        $arr = [
            'userid' => 'privacy:metadata:paygw_mpesakenya:userid',
            'transactionid' => 'privacy:metadata:paygw_mpesakenya:transactionid',
            'paymentid' => 'privacy:metadata:paygw_mpesakenya:paymentid',
            'moneyid' => 'privacy:metadata:paygw_mpesakenya:moneyid',
            'timecreated' => 'privacy:metadata:paygw_mpesakenya:timecreated',
            'timecompleted' => 'privacy:metadata:paygw_mpesakenya:timecompleted',
        ];
        $collection->add_database_table('paygw_mpesakenya', $arr, 'privacy:metadata:paygw_mpesakenya');
        return $collection;
    }
    ...
    public static function get_contexts_for_userid(int $userid): contextlist {
        ...
        $contextlist->set_component('paygw_mpesakenya');
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        if (count($contexts) > 0) {
            ...
            if ($context->contextlevel == CONTEXT_USER) {
                ...
                if ($records = $DB->get_records('paygw_mpesakenya', ['userid' => $user->id])) {
    ...
    public static function delete_data_for_all_users_in_context(\context $context) {
        global $DB;
        if (is_a($context, \context_user::class)) {
             $DB->delete_records('paygw_mpesakenya', ['userid' => $context->instanceid]);
        }
    }
    ...
    public static function delete_data_for_user(approved_contextlist $contextlist) {
        global $DB;
        $user = $contextlist->get_user();
        $DB->delete_records('paygw_mpesakenya', ['userid' => $user->id]);
    }
    ...
    public static function delete_data_for_users(approved_userlist $userlist) {
        ...
        if (is_a($context, \context_user::class)) {
            ...
            $DB->delete_records_select('paygw_mpesakenya', "userid $insql", $inparams);
        }
    }
    ...
    public static function export_payment_data(\context $context, array $subcontext, \stdClass $payment) {
        global $DB;
        $subcontext[] = get_string('gatewayname', 'paygw_mpesakenya');
        if ($record = $DB->get_record('paygw_mpesakenya', ['paymentid' => $payment->paymentid])) {
    ...
    public static function delete_data_for_payment_sql(string $paymentsql, array $paymentparams) {
        global $DB;
        $DB->delete_records_select('paygw_mpesakenya', "paymentid IN ({$paymentsql})", $paymentparams);
    }
}
